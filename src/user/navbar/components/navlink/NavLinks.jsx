...
export const NavLinks = () => {
  ...
  const rol = user.rol;
  return (
    <Box sx={{ width: 250, bgcolor: "background.paper", pt: 4, pl: 2 }}>
      <List sx={{ pr: 4 }}>
        {/* Inicio Section */}
        {rol !== 'user' &&
          <NavItem
        ...
        <Box key={navSection.section}>
          ...
          <List sx={{ pr: 4 }}>
            {navSection.items.map((item) => {
              // Si el rol es 'admin', mostrar todos los elementos, 
              // y si es 'user', solo mostrar los elementos asignados a 'user'
