...
import { ModalInfoActivo } from "./ModalInfoActivo";
...
export const TablaPerecederos = ({ paginated, handleOpenModal, getActivo, deleteActivo, handleGetData, createRegistro }) => {
  // ?Estados
  ...
  return (
    <TableContainer sx={{ mt: 2 }} >
          ...
          {sortedUsers.map((prod, index) => (
            <TableRow key={index} sx={styleTableRowHover}>
              ...
              <TableCell sx={styleTableBody} align="center">
                ...
                >
                  <MenuItem onClick={() => handleOpenInfoModal(prod.id)}>
                    <InfoOutlinedIcon />
                    Ver Informacion
                  </MenuItem>
      ...
      <ModalInfoActivo open={modalInfo.on} handleClose={handleCloseInfoModal} activo={modalInfo.data} />
