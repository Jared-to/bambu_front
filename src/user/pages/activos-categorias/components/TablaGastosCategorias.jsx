...
export const TablaActivosCategorias = ({ paginated, handleOpenModal,deleteCategoria,handleGetData }) => {
  //?Estados
  ...
  return (
    <TableContainer>
      ...
      <ModalEliminar open={modalDelete.on} handleClose={handleCloseModalDelete} handleFunction={handleDeleteCategoria} />
